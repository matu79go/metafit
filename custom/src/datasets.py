...
class DefaultDataset(Dataset):
    def __init__(
        ...
        # Artificially limit the size of the dataset. None = no limit.
        # Applied before xflip.
        max_size=None,
        use_labels=False,  # Enable conditioning labels?
        # False = label dimension is zero.
        # Artificially double the size of the dataset via x-flips.
        # Applied after max_size.
        xflip=False,
...
class UvitonDatasetFull_512(DefaultDataset):
    def __init__(
        self,
        ...
        if os.path.isdir(self._path):
            ...
            for dataset in dataset_list:
                txt_path = os.path.join(
                    self._path, dataset, "test_pairs.txt"
                )
            ...
            random_mask_acgpn_dir = os.path.join(
                self._path, "deepfashion/parsing"
            )
...
if __name__ == "__main__":
    # path=data, resolution = None, use_labels=True, max_size=None, xflip=False
    ds = UvitonDatasetFull_512(
        path="./data",
        resolution=None,
        use_labels=True,
        max_size=None,
