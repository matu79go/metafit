...
1. **Download model weights** (not included in this repo — download at your own responsibility):
   ...
   | Model | File | Download |
   |-------|------|----------|
   | PASTA-GAN++ | `network-snapshot-004408.pkl` | [Google Drive](https://drive.google.com/file/d/1oESyGm1Zcz2lWUO6AvKlj-pXWtvIRGZd/view?usp=sharing) (from [official repo](https://github.com/xiezhy6/PASTA-GAN-plusplus)) |
   | OpenPose | `body_pose_model.pth` (~209MB) | [HuggingFace](https://huggingface.co/lllyasviel/Annotators/resolve/main/body_pose_model.pth) |
   | Graphonomy | `inference.pth` (~167MB) | [HuggingFace](https://huggingface.co/zhengchong/FashionMatrix/resolve/main/graphonomy/inference.pth) |
...
|-----------|---------|------------|
| [PASTA-GAN++](https://github.com/xiezhy6/PASTA-GAN-plusplus) | Non-commercial research only | Try-on generation |
