...
def get_module_from_obj_name(obj_name: str) -> Tuple[types.ModuleType, str]:
    ...
    Returns the module and the object name
    (original name with module part removed).
    """
...
def construct_class_by_name(*args, class_name: str = None, **kwargs) -> Any:
    """
    Finds the python class with the given name and constructs
...
def is_top_level_function(obj: Any) -> bool:
    ...
    i.e., defined at module scope using 'def'.
    """
    return (
...
def open_url(
    ...
    """
    Download the given URL and return a binary-mode file object
    to access the data.
    """
                ...
                with session.get(url) as res:
                    ...
                    if len(res.content) < 8192:
                        ...
                        if "Google Drive - Quota exceeded" in content_str:
                            raise IOError(
                                "Google Drive download quota exceeded -- please try again later"  # noqa
                            )
